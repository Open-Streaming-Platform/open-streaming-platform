...
class User(db.Model, UserMixin):
    ...
    pushRegistrations = db.relationship('pushRegistration', backref='user', lazy="joined")
    channelSubscriptions = db.relationship('channelSubscription', backref='user', lazy="joined")