...
class User(db.Model, UserMixin):
    ...
    invites = db.relationship('invitedViewer', backref='user', lazy="subquery")
    channels = db.relationship('Channel', backref='owner', lazy="subquery")
    notifications = db.relationship('userNotification', backref='user', lazy="subquery")
    subscriptions = db.relationship('channelSubs', backref='user', cascade="all, delete-orphan", lazy="subquery")