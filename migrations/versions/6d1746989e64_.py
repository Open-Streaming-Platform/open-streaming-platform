...
def upgrade():
    ...
    op.create_table('channel_ban_list',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('chat_banned_messages',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('global_webhook',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=255), nullable=True),
    ...
    sa.ForeignKeyConstraint(['owningUser'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table('UsersFlaggedForDeletion',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('userID', sa.Integer(), nullable=True),
    sa.Column('timestamp', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['userID'], ['user.id'], ),
    ...
    op.create_table('messageBanList',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('userID', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['linkedChannel'], ['Channel.id'], ),
    sa.ForeignKeyConstraint(['rtmpServer'], ['rtmpServer.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('channelPanel',
    sa.Column('name', sa.String(length=255), nullable=True),
    sa.Column('type', sa.Integer(), nullable=True),
    sa.Column('header', sa.String(length=1024), nullable=True),
    sa.Column('order', sa.Integer(), nullable=True),
    ...
    op.create_table('channel_upvotes',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('userID', sa.Integer(), nullable=True),
    sa.Column('channelID', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['channelID'], ['Channel.id'], ),
    ...
    op.create_table('restreamDestinations',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=255), nullable=True),
    ...
    sa.Column('gifLocation', sa.String(length=255), nullable=True),
    sa.Column('published', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['parentVideo'], ['RecordedVideo.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('invitedViewer',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('userID', sa.Integer(), nullable=True),
    sa.Column('channelID', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['channelID'], ['Channel.id'], ),
    sa.ForeignKeyConstraint(['inviteCode'], ['inviteCode.id'], ),
    sa.ForeignKeyConstraint(['userID'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('stream_upvotes',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('userID', sa.Integer(), nullable=True),
    sa.Column('streamID', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['streamID'], ['Stream.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('videoComments',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('userID', sa.Integer(), nullable=True),
    sa.Column('timestamp', sa.DateTime(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['userID'], ['user.id'], ),
    sa.ForeignKeyConstraint(['videoID'], ['RecordedVideo.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['commentID'], ['videoComments.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
