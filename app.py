...
def streamers_view_page(userID):
    ...
    return render_template('themes/' + sysSettings.systemTheme + '/videoListView.html', openStreams=streams, recordedVids=recordedVideoQuery, userChannels=Channel.Channel.query, title=userName + " - Videos")
